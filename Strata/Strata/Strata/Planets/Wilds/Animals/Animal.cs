...
{
    abstract class Animal : Wild
    {
        public Animal(Planet plant, int tile)
            : base(plant, tile)
        {
        }
        ...
        protected override RectangleTexture3D GetRectangle(Camera3D cam)
        {
            ...
            Vector3 offset = (Width / 2) * Vector3.Normalize(Vector3.Cross(center, cam.View.Right));  // Horizontal offset from center
